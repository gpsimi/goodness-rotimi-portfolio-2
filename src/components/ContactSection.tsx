  ...
  return (
    <section id="contact" className="py-20 px-4 bg-muted/30">
      <div className="container mx-auto max-w-4xl text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground animate-fade-in">Let's Connect</h2>
        ...
        <div className="flex justify-center gap-4 mb-8 animate-scale-in" style={{ animationDelay: "0.4s" }}>
